      ...
      React.createElement("li", {key: this.props.article.arclSer}, 
        ...
        React.createElement("div", {className: "subject-detail", ref: "detail"}, 
          React.createElement("div", {className: "relation-lesson"}, 
            ...
            React.createElement("span", {style: {display:(this.props.article.jobNo == null || this.props.article.jobNo == "")?'none':''}}, React.createElement("strong", null, "직업"), React.createElement("a", {href: "javascript:void(0)", target: "_self", title: "새창열림"}, this.props.article.jobNm))
          ), 
          React.createElement("div", {className: ansClass2}, 
            React.createElement("div", {className: "question"}, 
              ...
              React.createElement("div", {className: "info", dangerouslySetInnerHTML: {__html : sust+""}})
            ), 
            React.createElement("div", {className: "answer", style: {display:ansClass}}, 
              React.createElement("span", {className: "title"}, "답변"), 
              React.createElement("div", {className: "info", dangerouslySetInnerHTML: {__html : ansSust+""}})
            ), 
    ...
    return (
        React.createElement("div", null, 
          React.createElement("div", {className: "title-group"}, 
            React.createElement("div", {className: "btn m-hide"}, 
              React.createElement("a", {href: "javascript:void(0)", className: "btn-border-type layer-open", title: "등록 팝업 - 열기", onClick: this.registClick}, "등록"), " ", React.createElement("br", null)
            )
          ), 
