        ...
        <li>
          <div className="title">
            <a href="javascript:void(0);" onClick={this.articleClick}>
              <em>[{this.props.article.dataTypeCdNm}]    {this.props.article.dataNm}</em>
              <span className="file" style={{display:(this.props.article.dataTypeCd == "101759")?"":"none"}}>1개({Math.ceil(totalSize/1024/1024)}MB)</span>
            </a>
          </div>
...
mentor.DataList = React.render(
  <DataList url={dataUrl} boardId='lecFile' />,document.getElementById('boardDataList')
);