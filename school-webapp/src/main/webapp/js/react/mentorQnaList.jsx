      ...
      <li key={this.props.article.arclSer}>
        ...
        <div className="subject-detail" ref="detail">
          <div className="relation-lesson">
              <span style={{display:(this.props.article.cntntsTargtNo != "")?'':'none'}}><strong>관련수업</strong><a href={lectureUrl} target="_self" title="새창열림"> {this.props.article.lectTitle}</a></span>
          </div>
...
var QnaList = React.createClass({
  ...
  render:function(){
    ...
    return (
        <div>
          <div className="title-group">
            <div className="btn">
              <a href="javascript:void(0)" title="등록 팝업 - 열기" className="btn-border-type layer-open" onClick={this.registClick}>등록</a>
            </div>
          </div>
    ...
    mentor.QnaList = React.render(
        <QnaList url={mentor.contextpath+'/community/ajax.arclList.do'} boardId='lecQnA' mbrNo={sMbrNo}/>,
