...
<div id="container">
    ...
    <div class="content sub">
        ...
        <p class="tit-desc-txt">나의 교실을 신청/관리할 수 있습니다.</p>
        <div class="board-list-type more">
            <!--<div class="btn">
                <a href="#myClassPop2" title="나의 교실 등록 팝업 - 열기" class="btn-border-type layer-open m-none" onClick="initPopup()">나의 교실 등록</a>
            </div>-->
            <div id="myManagementClassroomList">
            </div>
        </div>
    </div>
</div>
...
<div class="layer-pop-wrap my-class-reg" id="myClassPop2">
    <div class="layer-pop m-blind">
                ...
                <div class="box-style2 class"><form:form id="insertClassroomForm">
                    ...
                    <div class="class-opt" style="padding-left: 0px;text-align: center;">
                        ...
                        <span id="step3ClassName" style="width: 450px;">
                            ...
                            <select class="slt-style" title="반명" id="clasRoomNm2">
                                <option value="">선택</option>
        ...
        <div class="layer-cont" style="display:none" id="popupStep4">
            <div class="box-style">
                <strong class="title-style"><em>교실 등록이 완료</em> 되었습니다.<br />나의 교실에서 <em>등록 상태를 확인</em>하세요.</strong>
            </div>
            <div class="btn-area popup">
        ...
        <div class="layer-cont" style="display:none" id="approvePopStep2">
            <div class="box-style">
                ...
                <div class="box-style2 src-class approval"><form:form id="rejectForm"><input type="hidden" name="reqSer" id="approvePopStep2ReqSer"/>
                    <p><strong>학교 명</strong><span id="approvePopStep2SchNm"></span></p>
                    <p><strong>반 명</strong><span id="approvePopStep2ClaNm"></span></p>
                    <p><strong>학생 명</strong><span id="approvePopStep2MbrNm"></span></p>
...
function refreshMyClassroom(){
    mentor.myManagementClassroomList.getList({'isMore':false});
}
