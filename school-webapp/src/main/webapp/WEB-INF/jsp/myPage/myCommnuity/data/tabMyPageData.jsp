...
function search() {
  ...
  mentor.DataList.getList(param);
}

</script>

<script type="text/javascript" src="${pageContext.request.contextPath}/js/react/myPageDataList.js"></script>
<script type="text/javascript">
    mentor.DataList = React.render(React.createElement(DataList, {url: "${pageContext.request.contextPath}/community/ajax.arclList.do", boardId: "lecFile", mbrNo: "<%=user.getMbrNo()%>"}),document.getElementById('boardDataList'));
</script>