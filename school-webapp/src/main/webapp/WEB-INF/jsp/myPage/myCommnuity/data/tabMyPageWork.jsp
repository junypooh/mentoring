...
function search() {
  ...
  mentor.WorkList.getList(param);
}

</script>

<script type="text/javascript" src="${pageContext.request.contextPath}/js/react/myPageWorkList.js"></script>
<script type="text/jsx;harmony=true">
mentor.WorkList = React.render(<WorkList url='${pageContext.request.contextPath}/community/ajax.arclList.do' boardId='lecWork' mbrNo='<%=user.getMbrNo()%>' teacherYn='<%=teacherYn%>' />,document.getElementById('homeWorkList'));
</script>