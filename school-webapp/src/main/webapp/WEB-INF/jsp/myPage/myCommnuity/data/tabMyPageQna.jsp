...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/react/myPageQnaList.js"></script>
<script type="text/jsx;harmony=true">
mentor.QnaList = React.render(<QnaList url='${pageContext.request.contextPath}/community/ajax.arclList.do' boardId='lecQnA' />, document.getElementById('boardQnaList'));
</script>