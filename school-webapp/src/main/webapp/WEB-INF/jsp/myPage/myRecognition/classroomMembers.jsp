...
function refreshMyClassroom(){
    mentor.memberList.getList({'isMore':false,'clasRoomSer':mentor.memberList.props.clasRoomSer,'schNm':mentor.memberList.props.schNm});
}
...
mentor.memberList = React.render(
  <MemberList url='${pageContext.request.contextPath}/myPage/myClassroom/ajax.listApplyStudentSchInfo.do' clasRoomSer="<c:out value="${param.clasRoomSer}" />" myClass="<c:out value="${param.schNm}" />"/>,
