...
TrexConfig.addAttacher(
    "image",
    {
        ...
        popPageUrl: "#host#path/pages/trex/image.do"
    },
    function(root){
...
Trex.Attachment.Image = Trex.Class.create({
    ...
    getSaveHtml: function(data) {
        return "<img src=\"" + data.imageurl + "\" class=\"txc-image\" alt=\"" + data.dispElId + "\"/>";
    },
    getDispHtml: function(data) {
        return "<img id=\"" + data.dispElId + "\" src=\"" + data.imageurl + "\" class=\"txc-image\" alt=\"" + data.dispElId + "\"/>";
    },
