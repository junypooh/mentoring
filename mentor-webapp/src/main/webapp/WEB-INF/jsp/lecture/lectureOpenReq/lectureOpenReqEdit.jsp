...
<div id="container">
	...
	<div class="content">
		...
		<div class="cont type3">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" class="inp-style1" maxlength="50" style="width:682px;" id="lectTitle" value="${lectOpenReqInfo.lectTitle}"  /></td>
						</tr>
						<tr>
							<th scope="row" class="compulsory">내용</th>
							<td>
								<textarea id="lectSust" rows="" class="textarea" maxlength="200" cols="" >${lectOpenReqInfo.lectSust}</textarea>
							</td>
						</tr>
						<tr id="papers">
							...
							<td>
                                ...
                                <ul class="file-list-type01" id="${lectOpenReqInfo.fileSer}">
                                    <li>
                                        ...
                                        <a href="javascript:fn_fileDelete(${lectOpenReqInfo.fileSer})"><img src="${pageContext.request.contextPath}/images/common/btn_file_del.gif" alt="삭제"></a>
                                    </li>
                                </ul>
							</td>
						</tr>
			...
			<div class="btn-area">
				<a href="#" class="btn-type2" onclick="fn_save()">수정</a>
...
<script type="text/javascript">
    ...
    function fn_save(){
        ...
        if( confirm('수정하시겠습니까?')){
            $.ajax({
                url: '${pageContext.request.contextPath}/lecture/lectureOpenReq/ajax.edit.do',
                data : _param,
                ...
                success: function(rtnData) {
                        alert("수정되었습니다.");
                        location.href = '${pageContext.request.contextPath}/lecture/lectureOpenReq/lectureOpenReqView.do?reqSer=${lectOpenReqInfo.reqSer}';
                },
