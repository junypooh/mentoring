...
<div class="tab-cont active">
  ...
  <div class="lesson-task" id="boardWorkList"></div>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/react/lectureInfoWorkList.js" class="${param.arclSer}"></script>