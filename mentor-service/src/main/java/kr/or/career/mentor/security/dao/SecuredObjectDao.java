package kr.or.career.mentor.security.dao;
...
public class SecuredObjectDao {
    ...
    public static final String DEF_ROLES_AND_URL_QUERY =
            "SELECT ROLL_PTTN_INFO AS URL, AUTH_CD AS AUTHORITY FROM CNET_ROLL_AUTH_MAPP A INNER JOIN CNET_ROLL_INFO  B ON A.ROLL_CD  = B.ROLL_CD AND B.SITE_CLASS = '" + EgovProperties.getLocalProperty("Local.site") + "' AND B.USE_YN = 'Y' ORDER BY ROLL_PTTN_INFO";
