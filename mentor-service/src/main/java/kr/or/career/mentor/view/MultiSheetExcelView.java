...
import kr.or.career.mentor.domain.ExcelInfoDTO;
...
public class MultiSheetExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request,
        ...
        List<ExcelInfoDTO> excelSheetList  = (List<ExcelInfoDTO>)model.get("excelSheetList");

        for(ExcelInfoDTO excelInfo : excelSheetList){

            List<Object> domains = excelInfo.getListObject();

            HSSFSheet sheet = workbook.createSheet(excelInfo.getSheetNm());
            ...
            if (domains.size() > 0) {
                ...
                if (domains.get(0) instanceof Map) {
                    ...
                    ArrayList<Field> list = excelInfo.getFieldList();
