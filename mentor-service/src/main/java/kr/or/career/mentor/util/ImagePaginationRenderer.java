...
import kr.or.career.mentor.util.AbstractPaginationRenderer;
...
public class ImagePaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	...
	public void initVariables(){
      ...
      //  lastPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \"><img src=\"" + servletContext.getContextPath() +  "/images/egovframework/com/cmm/icon/icon_nextend.gif\" alt=\"마지막\" border=\"0\"/></a>&#160;";
        ...
        firstPageLabel    = "<a href=\"?pageIndex={1}\" class=\"prev\" onclick=\"{0}({1});return false; \"><처음</a>&#160;";
        ...
        lastPageLabel     = "<a href=\"?pageIndex={1}\" class=\"next\" onclick=\"{0}({1});return false; \">맨끝></a>&#160;";
	}
