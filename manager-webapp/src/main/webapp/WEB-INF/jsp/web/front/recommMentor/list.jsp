...
<script type="text/javascript">
    ...
    function goSearch(){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/web/front/ajax.hotMentors.do",
            success: callbackListData
        });
    }
    ...
    function callbackUpdated(selectedMentors){
        $.ajax({
            url: "${pageContext.request.contextPath}/web/front/ajax.insertHotMentor.do",
    ...
    function removeMentor(){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/web/front/ajax.deleteHotMentors.do",
