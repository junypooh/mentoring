...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#excelDown").click(function(e){
            e.preventDefault();
            var url = "${pageContext.request.contextPath}/statistics/member/conn/excel.do";
    ...
    function emptyData() {
        ...
        //jqGrid setting
        var colModels = [];
        colModels.push({label:'학교ID', name:'schNo', index:'schNo', width:100, align:'center', sortable: false});
        ...
        colModels.push({label:'담당자', name:'nm', index:'nm', align:'center', sortable: false});
        colModels.push({label:'핸트폰', name:'mobile', index:'mobile', align:'center', sortable: false});
        colModels.push({label:'참여구분', name:'joinClassCdNm', index:'joinClassCdNm', align:'center', sortable: false});
        colModels.push({label:'클래스수', name:'clsCnt', index:'clsCnt', align:'center', sortable: false});
        colModels.push({label:'참여수업수', name:'lectCnt', index:'lectCnt', align:'center', sortable: false});
    ...
    function loadData(){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/statistics/class/ajax.schoolList.do",
