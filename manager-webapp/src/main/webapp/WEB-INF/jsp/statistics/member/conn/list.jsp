...
<script type="text/javascript">
    ...
    function emptyData() {
        ...
        colModels.push({label:'교육수행기관', name:'corp', index:'corp', align:'center', sortable: false});
    ...
    function loadData(){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/statistics/member/conn/ajax.list.do",
            ...
            success: function(rtnData) {
                ...
                var corpSum = $("#boardTable").jqGrid('getCol','corp', false, 'sum');

                $("#boardTable").jqGrid('footerData','set',{day:'합계',element:elementSum, middle:middleSum, high:highSum, univ:univSum, normal:normalSum, parent:parentSum, teacher:teacherSum, mentor:mentorSum, corp:corpSum});
