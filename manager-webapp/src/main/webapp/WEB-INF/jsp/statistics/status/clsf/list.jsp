...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#schoolExcelDown").click(function(e){
            e.preventDefault();
            var url = mentor.contextpath + "/statistics/status/excel.mentorSummaryByJobCslf.do";
    ...
    function loadData(){
        ...
        colModels.push({label:'직업수', name:'jobCnt', index:'jobCnt', align:'center', sortable: false});
        colModels.push({label:'멘토수', name:'mentorCnt', index:'mentorCnt', align:'center', sortable: false});
        colModels.push({label:'수업수', name:'lectureCnt', index:'lectureCnt', align:'center', sortable: false});
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/statistics/status/ajax.mentorSummaryByJobCslf.do",
