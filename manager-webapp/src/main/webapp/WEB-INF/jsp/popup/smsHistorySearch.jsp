        ...
        <div id="popBoardArea" class="board-area">
            <div id="popBoardArea" class="pop-board-area">
                <div class="board-bot">
                    ...
                    <ul>
                        <li><button type="button" class="btn-orange" onclick="donePop();"><span>수신자복사 문자전송</span></button></li>
                        <li><button type="button" class="btn-gray" onclick="closePop();"><span>닫기</span></button></li>
                    </ul>
                </div>
                <table id="userList">
                </table>
